            ...
            <ul>
                <ul>
                    <li v-for="(item, i) in videoData" :key="i">
                        ...
                        <RouterLink :to="`/videoPlay/videoDetail/${item.data.vid}`">
                            <div v-if="!keletonShow">
                                <div class="image">
                                    <img class="pic " v-lazyload="item.data.coverUrl + '?param=200y200'" alt="">

                                    <!-- 遮罩层 -->
                                    <div class="masks"></div>
                                    <!-- 播放按钮 -->
                                    <i class=" playButtom iconfont  icon-bofang-copy"></i>
                                    <i class="duration">{{ item.data.duration }}</i>
                                </div>
                                <div class="desc">{{ item.data.title }}</div>
